...
def main():
    ...
    parser.add_argument('--save_step', default=470, type=int, help='Save checkpoint every save_step') # [5011 (images) / 32 (batch size)] * 3= 469.8
    parser.add_argument('--eval_step', default=470, type=int, help='Evaluate dataset every eval_step, disabled when eval_step < 0')
