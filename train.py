...
def main():
    ...
    parser.add_argument('--save_step', default=25, type=int, help='Save checkpoint every save_step')
    parser.add_argument('--eval_step', default=25, type=int, help='Evaluate dataset every eval_step, disabled when eval_step < 0')
